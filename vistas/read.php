...
<head>
<style type="text/css">
.banner-section{background-image:url("../imagenes/ver.jpg"); background-size:1500px 350px ; height: 380px; left: 0; position: absolute; top: 0; background-position:0; background-repeat: no-repeat; }
#cabecera {
    font-weight: bold;
  font-size: 68px;
  font-family: "Arial";
...
<section class="post-content-section">
    <div class="container">
        <div class="row" >
            ...
            <div id='cabecera'> <h1 class="display-1 text-center">Ver Luchador</h1></div>
            <div id="menu">    
